...
class Lcobucci extends Provider implements JWT
{
    ...
    {
        try {
            //$token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vbG9jYWxob3N0L2FzZkJhY2tlbmQvYXBpL2F1dGgvbG9naW4iLCJpYXQiOjE2NjA4MTIwMjIsImV4cCI6MTY2MDgxNTYyMiwibmJmIjoxNjYwODEyMDIyLCJqdGkiOiJrWGhpT25BTHluNlpScmRvIiwic3ViIjoiMSIsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.A1DvDKxjWb-QkJxOrue9u8fzzQxei61uKlZcauE9fw0';

            $jwt = $this->config->parser()->parse($token);
        } catch (Exception $e) {
            throw new TokenInvalidException('Could not 55 decode token: '. $token .'------'.$e->getMessage(), $e->getCode(), $e);
        }
